...
$news = get_field('news');
$terms = get_the_terms($post, 'news-category');
if ($terms) {
    $news = !empty($news) ? $news : $ajax->getNewsByCategory($terms[0], 10);
}
?>
...
<?php if (!is_admin()) : ?>
        ...
        <section class="news">
            <div class="container-xs">
                <div class="news__header">
                    <h2 class="news__title heading">Новости</h2>
                    <a href="/blog" class="news__see-more see-more">Смотреть все</a>
                </div>
                    ...
                    <div class="swiper-navigation custom-slider-navigation">
                        <div class="swiper-button-prev">
                            <svg xmlns="http://www.w3.org/2000/svg" width="59" height="59" viewBox="0 0 59 59"
                                ...
                                <rect width="31.0909" height="31.0909"
                                      transform="translate(45.0454 45.0454) rotate(180)"
                                      fill="#38393D"/>
                        ...
                        <div class="swiper-button-next">
                            <svg xmlns="http://www.w3.org/2000/svg" width="59" height="59" viewBox="0 0 59 59"
                                ...
                                <path d="M16.8509 1L40.2533 1L58 17.8048L58 41.8765L41.5488 58L17.4512 58L1 41.8765L1 17.8048L16.8509 1Z"
                                      fill="#38393D" stroke="#4A4C52" stroke-width="1.29545"/>
                                <rect width="31.0909" height="31.0909" transform="translate(13.9546 13.9546)"
                                      fill="#38393D"/>
    ...
    <?php endif; ?>
<?php else: ?>
    <h2 style="font-family: 'Mark', sans-serif;">Новости модуль</h2>
<?php endif; ?>